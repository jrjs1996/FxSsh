...
namespace FxSsh.Algorithms {
    public class DiffieHellman : AsymmetricAlgorithm {
        ...
        public DiffieHellman(int bitlen) {
            ...
            switch (bitlen) {
                case 1024:
                    this.p = BigInteger.Parse(okley1024, NumberStyles.HexNumber);
                    this.g = new BigInteger(2);
                    break;
                case 2048:
                    this.p = BigInteger.Parse(okley2048, NumberStyles.HexNumber);
                    this.g = new BigInteger(2);
                    break;
                default:
            ...
            rng.GetBytes(bytes);
            this.x = BigInteger.Abs(new BigInteger(bytes));
        }
